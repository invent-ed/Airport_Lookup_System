...
{
	union {
		placesArg airports_near_coord_1_arg;
	} argument;
	char *result;
	...
	case AIRPORTS_NEAR_COORD:
		_xdr_argument = (xdrproc_t) xdr_placesArg;
		_xdr_result = (xdrproc_t) xdr_airportsRet;
		local = (char *(*)(char *, struct svc_req *)) airports_near_coord_1_svc;
		break;
