...
{
	union {
		clientArg airports_near_city_1_arg;
	} argument;
	char *result;
	...
	case AIRPORTS_NEAR_CITY:
		_xdr_argument = (xdrproc_t) xdr_clientArg;
		_xdr_result = (xdrproc_t) xdr_placesRet;
		local = (char *(*)(char *, struct svc_req *)) airports_near_city_1_svc;
		break;
